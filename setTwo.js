...
// CODE HERE
function addingFactory2(num){
    return function(num2){
        return num + num2;
    }
}
console.log(addingFactory2(5)(10));

addingFactory = (num) => (num2) => num + num2;
console.log(addingFactory(5)(10));
...
/*
  Write a function called getUserById that takes in 
  three parameters: an array of objects (users), an id and a callback, and 
